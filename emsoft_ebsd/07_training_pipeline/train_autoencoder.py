...
# SETTINGS
# ======================================================================
OUT_DIR   = "/home/azza_osman/EMsoftData_work/07_training_pipeline"
DATA_FILE = "/home/azza_osman/EMsoftData_work/05_noising_training_data/training_pairs.h5"
MODEL_OUT = f"{OUT_DIR}/denoiser.keras"
...
PATIENCE   = 15                     # only used when EARLY_STOP is True
...
# ax.axhline(0.0022, ls="--", c="gray", lw=1, label="paper (0.0022)")
ax.set_xlabel("epoch")
...
for j in range(n_show):
    ...
    ax[2, j].set_title("clean target", fontsize=9)
    for i in range(3):
        ax[i, j].axis("off")
plt.tight_layout()
plt.savefig("denoise_examples.png", dpi=150, bbox_inches="tight")
plt.close(fig)
print("wrote denoise_examples.png")
