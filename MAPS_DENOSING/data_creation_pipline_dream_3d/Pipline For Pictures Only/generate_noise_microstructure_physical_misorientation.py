...
TEMPLATE_JSON = Path(
    r"C:\Users\Ahmed Alhassan\OneDrive\Desktop\Pipline For Pictures Only\Ni_pipline_A_generate_microstructure_with_pictures_noise_only.json"
)
OUTPUT_DIR = Path(r"C:\Users\Ahmed Alhassan\OneDrive\Desktop\Pipline For Pictures Only\Ni_dataset_new\ni_misorientation_maps")
...
NUM_MAPS = 40_000
FILENAME_PATTERN = "MisMap_{:05d}.png"  
